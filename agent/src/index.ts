...
async function executeCommand(cmd: { id: string; commandType: string; payload?: Record<string, unknown> }): Promise<void> {
...
async function main(): Promise<void> {
  ...
  console.log('[agent] Starting...', { API_URL, DEVICE_ID, ADB_SERIAL });
